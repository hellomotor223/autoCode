...
public class DbServiceImpl implements DbService {
	...
	public List<Map> getAllTablenames(){
		...
		try{
			...
			String sql = "select table_name name,table_comment comment from information_schema.tables where table_schema='ddbes-organization'";
			...
			while (resultSet.next()){
				...
				hashMap.put("comment", comment.lastIndexOf("表")!=-1?comment.substring(0, comment.lastIndexOf("表")):comment);
